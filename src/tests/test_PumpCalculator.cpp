...
TEST_METHOD(Waist_gauss)
{
    ...
    PumpCalculator calc(&p, lambda);

    // Beam at schema entrance
    BeamResult beam = calc.calcT(Matrix(), 1);
    ...
    // Output beam
    beam = calc.calcT({ -1.4379022, 0.1681906, -10.1543000, 0.4922850 }, 1);
...
TEST_METHOD(Waist_hyper)
{
    ...
    // Output beam
    beam = calc.calcT({ -1.3899498, 0.1731843, -9.8480800, 0.5075960 }, 1);
