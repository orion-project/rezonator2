...
private:
    ...
    double _M2 = 1.0;         ///< Beam quality parameter.
    ...
    double _re_q = 0.0;       ///< Real part of the complex ROC at distance z.
    double _im_q = 0.0;       ///< Imaginary part of the complex ROC at distance z.
    double _re_q1 = 0.0;      ///< Real part of the inverted complex ROC at distance z.
    double _im_q1 = 0.0;      ///< Imaginary part of the inverted complex ROC at distance z.
